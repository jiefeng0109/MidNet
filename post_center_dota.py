...
def post():
    ...
    files = os.listdir('exp/dota_side_center_dcn_cat_cpools/result/')
    ...
    for file_id, file_name in enumerate(files):
        res_path = 'exp/dota_side_center_dcn_cat_cpools/result/'
        ...
        img.save('results_dota_side_center_dcn_cat_cpools/bboxes/' + file_name[:-4] + '.png', quality=100)
        # print('results_dota_side_center_dcn_cat_cpools/bboxes/' + file_name[:-4] + '.png')
    ...
    for i, output in enumerate(outputs):
        det_txt = open('results_dota_side_center_dcn_cat_cpools/%s.txt' % names[i], 'w')
        for obj in output:
            det_txt.write(obj)
        det_txt.close()
