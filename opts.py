...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', default='fgsd',
                                 help='hrsc | dota | fgsd')
        self.parser.add_argument('--exp_id', default='fgsd')
        ...
        self.parser.add_argument('--demo', default='images',
        ...
        self.parser.add_argument('--lr_step', type=str, default='5,10,15,20,25,30,35,40',
                                 help='drop learning rate by 5.')
        ...
        self.parser.add_argument('--val_intervals', type=int, default=102400,
                                 help='number of epochs to run validation.')
        ...
        self.parser.add_argument('--K', type=int, default=2500,
        ...
        self.parser.add_argument('--flip_h', type=float, default=0.5,
                                 help='probability of applying flip augmentation.')
        self.parser.add_argument('--flip_v', type=float, default=0.5,
                                 help='probability of applying flip augmentation.')
        ...
        self.parser.add_argument('--center_weight', type=float, default=0.25,
                                 help='loss weight for keypoint heatmaps.')
        self.parser.add_argument('--side_weight', type=float, default=1,
                                 help='loss weight for keypoint heatmaps.')
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        if opt.task == 'ctdet':
            ...
            opt.heads = {'center_hm': opt.num_classes,
                         'left_hm': opt.num_classes,
                         'top_hm': opt.num_classes,
                         'right_hm': opt.num_classes,
                         'bottom_hm': opt.num_classes,
                         'center_wh': 1,
                         'left_wh': 2,
                         'top_wh': 2,
                         'right_wh': 2,
